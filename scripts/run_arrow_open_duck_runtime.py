...
def main() -> None:
    ...
    parser.add_argument(
        "--runtime-script",
        type=Path,
        default=default_runtime_root / "scripts/v2_rl_walk_mujoco.py",
    )
    parser.add_argument(
        "--onnx_model_path",
        type=Path,
        default=default_runtime_root / "BEST_WALK_ONNX_2.onnx",
    )
    parser.add_argument(
        "--duck_config_path",
        type=Path,
        default=default_runtime_root / "duck_config.json",
    )
